			...
			for (var i=0; i<root.length; i++) {
				...
				if (l1.is_file) {
					...
					if (entry != null) {
						...
						// entry.draw(domID)
						mod.label([entry.coord[0], entry.coord[1]+entry.r + 15], l1.value, domID)
