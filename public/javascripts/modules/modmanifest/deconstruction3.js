...
class Deconstruction3 extends Module {
	...
	gen() {
		...
		for (var x=0; x<xmax; x+=module.getConfigVal("amp8", module.params["amp8"])) {
			// drawLine([x,0], [x,ymax], "#fff", Math.abs(10*noise.simplex2(x, ymax)), module.getDomID())
			drawLine([x,0], [x,ymax], "#fff", Math.abs(module.getConfigVal("amp9",module.params["amp9"])*noise.perlin2(x/xmax, 1)), module.getDomID())
		}
