...
class Automata9 extends Module {
			...
			for (var j=0; j<this.height; j++) {
				...
				if (this.vector[offset] != null) {
					if (this.vector[offset]) {
						...
						// if (Math.random() < 0.2) {
							this.circle(ctx, i*this.sqSize, j*this.sqSize, j%(this.sqSize/2), "#fff")
						// } else {
						// 	this.rect(ctx, i*this.sqSize, j*this.sqSize, j%(this.sqSize/2), j%(this.sqSize/2), "#fff")
						// }
					} else {
