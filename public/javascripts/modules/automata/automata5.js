...
class Automata5 extends Module {
			...
			for (var j=0; j<this.height; j++) {
				...
				if (this.vector[offset] != null) {
					if (this.vector[offset]) {
						...
						this.circle(ctx, i*this.sqSize, j*this.sqSize, this.sqSize/3,"#000")
						this.circle(ctx, i*this.sqSize, j*this.sqSize, this.sqSize/3*Math.random(),this.getColor())
					} else {
						this.circle(ctx, i*this.sqSize, j*this.sqSize, this.sqSize/3,"#000")
