...
class TwitterFirehose3 extends Module {
	...
	render() {	
		...
		for (var i=-10; i<20; i++) {
			...
			text( { 
				...
				"fill": invert ? "#fff" : "#000",
				"transform": "rotate(" + 0 + " " + xmax/2 + " " + ymax/2 + ")",
				"style": "font-size:" + (Math.random() < 1 ? xmax/4 : this.getConfigVal("fontSize", ymax*0.08)*(Math.random() < 0.3 ? 1 : 1)) + "px;text-align:left;alignment-baseline:left;text-anchor:left;opacity:1.0;font-family:" + "Helvetica" + ";sans-serif;font-weight:" + 700 + ";letter-spacing:" + "-2px;"
...
export default TwitterFirehose3;
