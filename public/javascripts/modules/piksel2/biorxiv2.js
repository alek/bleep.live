...
class Biorxiv2 extends Module {
	...
	render() {	
		...
		for (var i=0; i<ymax; i+=14) {
			if (i == 14*Math.floor(ymax/14)) {
				drawText([xmax/2,ymax/2], getRandomString('GATC',32), "14px", "#fff", 100, 5,"Roboto Mono", this.getDomID())
			}
			else if (Math.random() < 0.5) {
				drawText([xmax/2,i], getRandomString('GATC',32), "14px", "rgba(255,255,255," + Math.random()/4 + ")", 100, 5,"Roboto Mono", this.getDomID())	
			}
