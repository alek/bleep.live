...
class MMLogo4 extends Module {
	...
	render() {	
		...
		$.get( "http://localhost:5133/images/modular/mm03-04.svg", function( data ) {
	...
	layer() {
		var p = this.getConfigVal("p", 0.05)
		...
		var delay = this.getConfigVal("delay", 3000)
