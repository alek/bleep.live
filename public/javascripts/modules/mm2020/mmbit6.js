...
class MMBit6 extends Module {
	...
	render() {	
		...
		Piksel.addCircularClip("glitchClip-1", xmax/2, ymax/2, ymax*0.3)
		...
		// drawCircleOutline([xmax/2,ymax/2], ymax*0.35, "rgba(255,255,255," + Math.random() + ")", 10 + "px", this.getDomID())
