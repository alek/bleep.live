...
class MMBit3 extends Module {
	...
	render() {	
		...
		var polygon = this.randomPolygon(7, xmax/4,ymax/4, [xmax/2,ymax/2]) 
		...
		//drawText([xmax/2, ymax*0.95], this.randomQuery()["term"].toUpperCase(), ymax*0.02 + "px", "#fff", 100, 10, "JetBrains Mono", this.getDomID())
