...
class MMBit8 extends Module {
	...
	render() {	
		...
		for (var i=0; i<ymax; i+=64) {
			drawText([xmax/2, i], this.randomQuery()["term"], "48px", "rgba(255,255,255," + Math.random() + ")", 100, 0, "JetBrains Mono", this.getDomID())
		}
