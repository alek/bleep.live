...
class Inevitable4 extends Module {
	...
	line(ctx, start, end, color) {
		...
		ctx.lineWidth = this.params["r3"]/5
	...
	render() {	
		...
		var radius = ymax*(this.params["r1"]/1024)
