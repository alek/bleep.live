//
// Experimenting with camera motion
// 

import Module from '../../lib/module.js'

class Exoplanets6 extends Module {
	...
	perspective(coord, height) {
		...
		var z = this.size*timeSlide(2700,1) - height + point[1]*timeSlide(3000,1)
		var x = (point[0] - this.size*0.5)*6
		// var x = (point[0] - this.size*timeSlide(2000,1))*6
		// var y = (this.size - coord[1])*0.005 + 0
		var y = (this.size - coord[1])*(0.01-timeSlide(5000,0.003)) + 0
